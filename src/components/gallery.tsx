...
const ModernGallery: React.FC = () => {
  ...
  const galleryImages: GalleryImage[] = [
    // Window Cleaning
    {
      ...
      src: "/window-cleaning/gallery/gallery1.jpg",
    ...
    },
    {
      id: 2,
      category: "Window Cleaning",
      src: "/window-cleaning/gallery/gallery2.jpg",
    ...
    },
    {
      id: 3,
      category: "Window Cleaning",
      src: "/window-cleaning/gallery/gallery3.jpg",
    ...
    },
    {
      id: 13,
      category: "Window Cleaning",
      src: "/window-cleaning/gallery/gallery9.jpg",
      alt: "Residential window cleaning",
      description: "Crystal clear windows for your home",
    },
    {
      id: 14,
      category: "Window Cleaning",
      src: "/window-cleaning/gallery/gallery10.jpg",
      alt: "Residential window cleaning",
      description: "Crystal clear windows for your home",
    },
    {
      id: 15,
      category: "Window Cleaning",
      src: "/window-cleaning/gallery/gallery11.jpg",
      alt: "Residential window cleaning",
      description: "Crystal clear windows for your home",
    },
    ...
    // Gutter Cleaning
    {
      ...
      src: "/window-cleaning/gallery/gallery4.jpg",
    ...
    },
    {
      id: 5,
      category: "Gutter Cleaning",
      src: "/window-cleaning/gallery/gallery5.jpg",
    ...
    },
    {
      id: 6,
      category: "Gutter Cleaning",
      src: "/window-cleaning/gallery/gallery6.jpg",
    ...
    // Pressure Washing
    {
      ...
      src: "/window-cleaning/gallery/pressure-1.jpg",
    ...
    },
    {
      id: 8,
      category: "Pressure Washing",
      src: "/window-cleaning/gallery/pressure-2.jpg",
    ...
    },
    {
      id: 9,
      category: "Pressure Washing",
      src: "/window-cleaning/gallery/pressure-3.jpg",
    ...
    // Christmas Lights
    {
      ...
      src: "/window-cleaning/gallery/gallery7.jpg",
    ...
    },
    {
      id: 11,
      category: "Christmas Lights",
      src: "/window-cleaning/gallery/gallery8.jpg",
    ...
    },
    {
      id: 12,
      category: "Christmas Lights",
      src: "/window-cleaning/gallery/gallery12.jpg",
